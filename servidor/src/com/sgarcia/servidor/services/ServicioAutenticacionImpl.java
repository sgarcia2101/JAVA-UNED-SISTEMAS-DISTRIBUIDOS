...
public class ServicioAutenticacionImpl extends UnicastRemoteObject implements ServicioAutenticacionInterface {
	 ...
	 * 
	 * @see
	 * com.sgarcia.commons.services.ServicioAutenticacionInterface#registrarCliente(
	 * java.lang.String)
	 */
	@Override
	public int registrarCliente(String nombre) throws RemoteException {
		ServicioDatosInterface servicioDatos = ((ServicioDatosInterface) RMIUtils
				.getServiceByName(Constants.NOMBRE_SERVICIO_DATOS));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sgarcia.commons.services.ServicioAutenticacionInterface#
	 * registrarRepositorio(java.lang. String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sgarcia.commons.services.ServicioAutenticacionInterface#autenticarCliente
	 * (int)
	 */
	@Override
